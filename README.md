...
| :---------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![Elite Dashboard](hero.png)                    | 🌟 **Elite Admin Dashboard**<br>An advanced, meticulously engineered 8-page dashboard. Achieved a flawless 400/400 Lighthouse score on every single page with 0 CLS.<br>🔗 [Live Demo](https://ahmed-let-front.github.io/Dashboard-01/) \| [Repo](https://github.com/Ahmed-let-front/Dashboard-01)                                           |
