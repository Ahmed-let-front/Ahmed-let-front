...
<h3 align="center">Passionate Front-End Developer | UI Architect | 15 Years Old</h3>
...
### 👤 About Me
I’m **Ahmed**, a 15-year-old Front-End Developer. For the past **7 months**, I’ve been coding for **8+ hours daily**. I’ve successfully completed **10 Projects**:
* 🏆 **7 Frontend Mentor Challenges** (Mastering complex UI components).
* 🚀 **3 Professional Landing Pages** (Focusing on structure and performance).
* ⚡ My latest project is fully built using **Tailwind CSS v4**.
...
<h3 align="center">مطور واجهات مستخدم شغوف | 15 سنة</h3>
...
### 👤 عني
أنا **أحمد**، مطور واجهات مستخدم عندي 15 سنة. بقالي **7 شهور** ببرمج بمعدل **8 ساعات يومياً**. أنجزت حتى الآن **10 مشاريع**:
* 🏆 **7 تحديات من Frontend Mentor** (إتقان بناء مكونات UI المعقدة).
* 🚀 **3 صفحات هبوط (Landing Pages)** احترافية.
* ⚡ أحدث مشاريعي تم بناؤه بالكامل باستخدام **Tailwind CSS v4**.
